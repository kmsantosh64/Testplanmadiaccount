...
<form  id="partnerdetailcapture" method="post" action="<?php echo home_url(); ?>/gifts-enquiry/">
                        <input type="hidden" value="<?php echo get_field ('partner_name');?>" id="partnername" name="partnername"/>
                        <input type="submit" class="cta-button" value="Order Now"/>
                        </form>
...
if( !empty( $image ) ): ?>
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12 col-12 column-2" id="col-divs">
                <div class="about-me-contents">
                    ...
                    <div>
                        <!-- <form id="partnerdetailcapture" method="post" action="<?php echo home_url(); ?>/<?php echo get_field('service_type_url'); ?>/">
                        <input type="hidden" value="<?php echo get_field ('partner_name');?>" id="partnername" name="partnername"/>
                        <input type="submit" class="cta-button" value="Work with me"/>
                        </form> -->
                   <!-- <button class="cta-button">Work with me</button>
                   <a style="display:none;" href="<?php echo home_url(); ?>/<?php echo get_field('service_type_url'); ?>/">Test</a> -->
                    <form  id="partnerdetailcapture" method="post" action="<?php echo home_url(); ?>/gifts-enquiry/">
                        <input type="hidden" value="<?php echo get_field ('partner_name');?>" id="partnername" name="partnername"/>
                        <input type="submit" class="cta-button" value="Work with me"/>
                        </form>
