...
$location = $_POST['calocation'];
$persons = $_POST['canumberofpersons'];
...
$mailer1->IsHTML(true);
$email_subject="$name has requested Catering on $formattedEventDate in $location";  
$email_body ="
An enquiry for Catering Services
The details requested are below.
Name : <strong>$name</strong>
Phone : <strong>$phone</strong>
Email : <strong>$email</strong>
Date: <strong>$formattedEventDate</strong>
