...
<div class="hero-section-blog-image">
    <img load="eager" src="<?php bloginfo('template_directory') ?>/images/plan-madi-blogs.webp"/>
...
<div class="fixed-columns">
    ...
    <?php 
        ...
        ?>
<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 blog-content-card">
<div class="blog-card">
   ...
   <img src="<?php echo $image_url[0]; ?>" class="blog-image"/>
   <?php } ?>
   <h4><?php the_title(); ?></h4>
   <p><?php echo wp_trim_words( get_the_content(), 15 ); ?></p>
   
   <div class="card-contents">
   <p><img src="<?php bloginfo('template_directory') ?>/images/published-date.png" class="blog-card-icons"/><?php the_time( 'F jS, Y' ); ?></p>
   <p><img src="<?php bloginfo('template_directory') ?>/images/reading-time.png" class="blog-card-icons"/><?php echo do_shortcode('[rt_reading_time  postfix="mins"]'); ?></p>
                                    ...
                                    <a href="<?php the_permalink(); ?>">
                                        ...
                                        <div class="card-contents">
                                            <span><img
                                                    ...
                                                    class="blog-card-icons" /><?php the_time('F jS, Y'); ?></span>
