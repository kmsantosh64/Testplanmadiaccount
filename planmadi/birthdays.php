<?php /* Template Name:birthday Page */ ?>
    ...
    <div class="fixed-columns">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12">
                <h1>Life should be celebrated with
                    Cake, candles, and lots of smiles.</h1>
                <a href="#contact-us">Plan Madi</a>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12">
                <img  src="<?php bloginfo('template_directory') ?>/images/plan-madi-birthdays.webp" class="single-event-image"
                    alt="for birthdays" />
            </div>
        </div>
    </div>
...
<section id="about-individual">
    <div class="fixed-columns">
        <h2>Step into a new year of life with laughter, love, and unforgettable moments. Let's make this birthday a
            vibrant celebration of you. <span>Plan Madi.</span></h2>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" id="col-divs">
                <div class="row" id="service-row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-12" id="col-divs">
                        <div class="service-card">
                            <img loading="lazy" src="<?php bloginfo('template_directory') ?>/images/photography.svg"
                                class="service-icons" />
                            <h4>Photography</h4>
        ...
        <div class="contact-form">
            <form id="general-contact-form" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-item">
                            <input type="text" name="service" id="service" class="cntinp" value="Birthday Party" readonly/>
