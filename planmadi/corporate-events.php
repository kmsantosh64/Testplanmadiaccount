<?php /* Template Name:corporate Page */ ?>
    ...
    <div class="fixed-columns">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12">
                <h1>Success is best when its shared and celebrated together.</h1>
                <a href="#contact-us">Plan Madi</a>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12">
                <img fetchpriority="high" as="image" src="<?php bloginfo('template_directory') ?>/images/plan-madi-corporate-events.webp" class="single-event-image"
...
<section id="about-individual">
    <div class="fixed-columns">
        <h2>Set the stage for collaboration and success. Make your corporate event a standout success that reflects your company's vision. <span>Plan Madi.</span></h2>
    </div>
</section>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" id="col-divs">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-12" id="col-divs">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-12" id="col-divs">
                        <div class="service-card">
                            <img loading="lazy"
                                src="<?php bloginfo('template_directory') ?>/images/photography.svg"
                                class="service-icons" />
                            <h4>Photography</h4>
                            <p>Capture beautiful moments with our experts.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-12" id="col-divs">
                        <div class="service-card">
                            <img loading="lazy" src="<?php bloginfo('template_directory') ?>/images/customized-gifts.svg"
                                class="service-icons" />
                            <h4>Customized gifts</h4>
                            <p>Make your team feel special with our special customized handmade hampers.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-12" id="col-divs">
                        <div class="service-card">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-12" id="col-divs">
                        <div class="service-card">
                            <img loading="lazy" src="<?php bloginfo('template_directory') ?>/images/location.svg"
                                class="service-icons" />
                            <h4>Resorts</h4>
                            <p>Let us handle the search for you. Find your perfect resort stress-free with us.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="contact-form">
            <form id="general-contact-form" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-item">
                        <input type="text" name="service" id="service" class="cntinp" value="Corporate Events" readonly/>
